...

{
    ...
    systemd.tmpfiles.rules = [
        ...
        "L+ /home/user/Desktop/scripts/setup/import_btc_seed.sh - - - - /etc/scripts/wrappers/import_btc_seed.sh"
        "L+ /home/user/Desktop/scripts/setup/wgHMAC_export.sh - - - - /etc/scripts/wrappers/wgHMAC_export.sh"
    ];
